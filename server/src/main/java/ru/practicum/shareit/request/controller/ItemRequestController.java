...
public class ItemRequestController {
    ...
    public ResponseEntity<ItemRequestResponseDto> getById(@PathVariable @Positive long requestId,
                                                          @RequestHeader(value = "X-Sharer-User-Id") @Positive Long userId) {
        log.info("Получен GET запрос по эндпоинту /requests/{} на получение ItemRequest c ID {} для User с ID {}.", requestId, requestId, userId);
